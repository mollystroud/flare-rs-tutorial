...
If you are running this in the provided Docker (recommended), many packages are already installed, including GLM3r and FLAREr. If you are running this outside of the contained, you will need to install these packages.
